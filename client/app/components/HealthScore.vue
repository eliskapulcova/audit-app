  ...
  >
    <div class="flex flex-col lg:flex-row items-center justify-between gap-8">
      <div class="flex-1 text-center lg:text-left">
        ...
        <p v-if="healthScore.score != null" class="text-slate-400 mb-6">
          Aggregated across {{ projectSummary.tools.length }} tools,
          {{ projectSummary.repositoryCount }} repositories
        </p>
        <p v-else class="text-slate-400 mb-6">Health score not available</p>

        <template v-if="healthScore.score != null">
          <div
            v-if="healthScore.grade"
          ...
          <p
            v-if="healthScore.previousScore"
