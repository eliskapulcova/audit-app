      ...
      <div class="flex flex-col divide-y divide-gray-500">
        ...
        >
          <h2
            ...
            @click="() => navigateTo(`/projects/${name.toLowerCase()}/${tool.toLowerCase()}/audits/${report.id}`)"
          >
...
const { data, pending, error } = useFetch(`/api/projects/${name.toLowerCase()}/${tool.toLowerCase()}/audits`);
</script>
